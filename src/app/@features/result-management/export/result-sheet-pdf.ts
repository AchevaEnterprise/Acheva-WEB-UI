...
/**
 * The serial and QR printed at the foot of a document being taken away. Absent
 * on a preview, which mints no serial.
 */
    ...
    content: [
      ...
      // Kept together so a signature block never lands alone on a last page.
      {
        ...
        stack: [
          ...
          provenance
            ? verificationBlock(sheet, provenance)
            : {
                text:
...
/**
 * What makes the printed sheet checkable: a QR to the public verifier and the
 * same serial in text, because a photocopied QR often will not scan.
 *
 * The wording matters. It tells the reader what to DO — open the address, then
 * compare what it shows against the paper in hand — because proving only that
 * "a document with this serial was issued" would not catch an altered score.
 */
function verificationBlock(
  ...
  return {
    margin: [0, 12, 0, 0],
    columns: [
      { image: provenance.qrDataUrl, width: 58, height: 58 },
      {
        width: '*',
        margin: [10, 4, 0, 0],
        stack: [
          { text: 'VERIFY THIS DOCUMENT', fontSize: 8, bold: true },
          {
          ...
          },
          {
            text:
              ...
              `Check that what it shows matches this sheet — an altered copy will not match.`,
            fontSize: 7,
            color: '#444444',
          },
          {
            text:
              ...
              `Approvals above are recorded electronically.`,
            fontSize: 6.5,
            color: '#777777',
            margin: [0, 2, 0, 0],
          },
